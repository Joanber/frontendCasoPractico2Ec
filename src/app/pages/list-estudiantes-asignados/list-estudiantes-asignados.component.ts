...
@Component({
  selector: 'app-list-estudiantes-asignados',
  templateUrl: './list-estudiantes-asignados.component.html',
  styleUrls: ['./list-estudiantes-asignados.component.css']
})
export class ListEstudiantesAsignadosComponent implements OnInit {
